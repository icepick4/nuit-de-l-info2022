...
function initQuestion() {
  ...
  loadQuestion().then(() => {
    ...
    modal.children[0].children[1].children[0].innerHTML = question.responses[0];
    modal.children[0].children[1].children[1].innerHTML = question.responses[1];
    modal.children[0].children[1].children[2].innerHTML = question.responses[2];
    toggleModal();
  });
}
/*
